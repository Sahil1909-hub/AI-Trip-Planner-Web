    ...
    <div className='p-3 shadow-sm flex justify-between items-center px-5 '>
      ...
      <div>
        ...
        <div className='flex items-center gap-3'>
          ...
          <Popover>
              <PopoverTrigger> <img src={user?.picture} alt="" className='h-[35px] w-[35px] rounded-full cursor-pointer' /></PopoverTrigger>
        ...
        :
        <Button className='cursor-pointer' onClick={() => setOpenDailog(true)}>
        Sign In
      </Button>
        }
